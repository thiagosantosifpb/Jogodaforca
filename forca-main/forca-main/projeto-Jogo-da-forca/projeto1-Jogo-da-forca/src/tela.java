...
public class tela extends JFrame {
	...
	public tela() throws IOException {
		...
		Path caminho = Paths.get("src/dados/palavras.txt");
		JogoDaForca jogo = new JogoDaForca(caminho.toString());
		
		
		ImageIcon i0= new ImageIcon(getClass().getResource("/imagens/0.png"));;
		ImageIcon i1= new ImageIcon(getClass().getResource("/imagens/1.png"));
		ImageIcon i2= new ImageIcon(getClass().getResource("/imagens/2.png"));
		ImageIcon i3= new ImageIcon(getClass().getResource("/imagens/3.png"));
		ImageIcon i4= new ImageIcon(getClass().getResource("/imagens/4.png"));
		ImageIcon i5= new ImageIcon(getClass().getResource("/imagens/5.png"));
		ImageIcon i6= new ImageIcon(getClass().getResource("/imagens/6.png"));
